...
urlpatterns = patterns('',
    ...
    url(r'^professor/disciplina/(?P<pk>\d+)/curriculum/add$', views.professor_curriculum_add, name='professor_curriculum_add'),
    url(r'^professor/disciplina/(?P<pk>\d+)/curriculum/list$', views.professor_disciplina_curriculum, name='professor_disciplina_curriculum'),
    ...
    url(r'^professor/disciplina/topico_suporte/$', views.professor_disciplina_topico_suporte, name='professor_disciplina_topico_suporte'),
    url(r'^professor/disciplina/(?P<pk1>\d+)/(?P<pk2>\d+)/topico_suporte/$', views.professor_disciplina_topico_suporte_add, name='professor_disciplina_topico_suporte_add'),
